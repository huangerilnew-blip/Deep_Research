...
class ArxivSearcher(PaperSource):
    ...
    def __init__(self):
        ...
        self.senssion=httpx.AsyncClient() ##verify=False 跳过证书验证
    async  def search(self, query: str, max_results: int = 10) -> List[Paper]:
        ...
        response = await  self.senssion.get(self.BASE_URL, params=params)
    ...
    async def download_pdf(self, paper_id: str, save_path: str) -> str:
        ...
        response = await  self.senssion.get(pdf_url)
...
if __name__ == "__main__":
    ...
    if papers:
        ...
        try:
            ...
            pdf_path = asyncio.run(searcher.download_pdf(paper_id, save_path))
